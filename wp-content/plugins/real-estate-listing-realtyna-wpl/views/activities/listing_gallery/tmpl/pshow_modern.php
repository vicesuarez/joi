    ...
    <ul class="wpl-gallery-pshow" id="wpl_gallery_container<?php echo $this->property_id; ?>">
        ...
        else
        {
            foreach($this->gallery as $image)
            {
                ...
                ?>
                <li id="wpl-gallery-img-<?php echo $image['raw']['id']; ?>" data-thumb="<?php echo $image_thumbnail_url; ?>" data-src="<?php echo $image_url; ?>" data-hover-title="<?php echo __('Click to see gallery', 'wpl'); ?>" style="position:absolute;opacity:0;">
                    <span>
