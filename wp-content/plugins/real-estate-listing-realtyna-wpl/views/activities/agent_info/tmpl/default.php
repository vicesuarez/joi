...
<div class="wpl_agent_info" id="wpl_agent_info<?php echo $main_user_id; ?>" itemscope>
	...
	<?php if($is_multi_agent) echo '<div class="wpl_multi_agent_info clearfix">'; ?>
		...
		<div class="wpl_agent_info_r">
			<ul>
				<li class="name" itemprop="name"><a href="<?php echo $user_data['profile_url']; ?>"><?php echo $user_data['agent_name'].' '.$user_data['agent_l_name']; ?></a></li>

				<?php if(isset($user_data['wpl_user']['materials']['website']['value'])): ?>
				<li class="website"><a itemprop="url"  href="<?php echo $user_data['wpl_user']['materials']['website']['value']; ?>" target="_blank"><?php echo __('View website', 'wpl') ?></a></li>
				<?php endif; ?>
				...
				<li itemprop="faxNumber" class="fax"><?php echo $user_data['wpl_user']['materials']['fax']['value']; ?></li>
				<?php endif; ?>

				<?php if(isset($user_data['wpl_user']['main_email_url'])): ?>
				<li class="email">
					<?php if($mailto): ?>
					<a itemprop="email" href="mailto:<?php echo $user_data['wpl_user']['materials']['main_email']['value']; ?>"><img src="<?php echo $user_data['wpl_user']['main_email_url']; ?>" alt="<?php echo $user_data['agent_name']. ' '.$user_data['agent_l_name']; ?>" /></a>
					<?php else: ?>
				...
				<li class="second_email">
					<?php if($mailto): ?>
					<a itemprop="email" href="mailto:<?php echo $user_data['wpl_user']['materials']['secondary_email']['value']; ?>"><img src="<?php echo $user_data['wpl_user']['second_email_url']; ?>" alt="<?php echo $user_data['agent_name']. ' '.$user_data['agent_l_name']; ?>" /></a>
					<?php else: ?>
