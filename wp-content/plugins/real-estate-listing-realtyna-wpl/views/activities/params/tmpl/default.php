...
<div class="<?php echo $element_class; ?> fanc-params-wp fanc-content size-width-1" id="<?php echo $element_id; ?>">
    <h2><?php echo __('Parameters', 'wpl'); ?></h2>
    <div class="fanc-body">
        <div class="fanc-row fanc-button-row-2">
            <span class="ajax-inline-save" id="<?php echo $html_ajax_loader; ?>"></span>
            <input class="wpl-button button-1" type="button" value="<?php echo __('Save', 'wpl'); ?>" onclick="<?php echo $js_function; ?>();" />
        </div>
        <div class="fanc-row">
        ...
        <div class="fanc-row" id="wpl_param_row<?php echo $i; ?>">
            <input type="text" name="wpl_params[keys][]" placeholder="<?php echo __('Key', 'wpl'); ?>" value="<?php echo $key; ?>" />
            <input type="text" name="wpl_params[values][]" placeholder="<?php echo __('Value', 'wpl'); ?>" value="<?php echo $value; ?>" />
...
function wpl_add_param()
{
	html = '<div class="fanc-row" id="wpl_param_row' + wpl_params_i + '">'+
			'<input type="text" name="wpl_params[keys][]" placeholder="<?php echo __('Key', 'wpl'); ?>" /> '+
			'<input type="text" name="wpl_params[values][]" placeholder="<?php echo __('Value', 'wpl'); ?>" /> '+
