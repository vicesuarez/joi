...
class wpl_activity_main_params extends wpl_activity
{
	...
	public function display()
	{
        ...
        // Check Nonce
        if(!wpl_security::verify_nonce(wpl_request::getVar('_wpnonce', ''), 'wpl_activity_params')) $this->response(array('success'=>0, 'message'=>__('The security nonce is not valid!', 'wpl')));
	...
	private function save_params()
	{
		...
		$res = 1;
		$message = $res ? __('Params Saved.', 'wpl') : __('Error Occured.', 'wpl');
		$data = NULL;
