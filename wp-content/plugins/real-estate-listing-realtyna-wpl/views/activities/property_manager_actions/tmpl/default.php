...
<div id="pmanager_action_div<?php echo $pid; ?>" class="p-actions-wp pmanager_actions">
    ...
    <div id="pmanager_change_user<?php echo $pid; ?>" class="change-user-cnt-wp">
        <div class="change-user-wp">
            <label id="pmanager_change_user_label<?php echo $pid; ?>" for="pmanager_change_user_select<?php echo $pid; ?>"><?php echo __('User', 'wpl'); ?>: </label>
    ...
    <div id="pmanager_confirm<?php echo $pid; ?>" class="p-action-btn" onclick="confirm_property(<?php echo $pid; ?>);">
        <span><?php echo($property_data['confirmed'] == 1 ? __('Confirmed', 'wpl') : __('Unconfirmed', 'wpl')); ?></span>
    ...
    <div id="pmanager_trash<?php echo $pid; ?>" class="p-action-btn" onclick="trash_property(<?php echo $pid; ?>);">
        <span><?php echo($property_data['deleted'] == 1 ? __('Restore', 'wpl') : __('Trash', 'wpl')); ?></span>
    ...
    <div id="pmanager_clone<?php echo $pid; ?>" class="p-action-btn" onclick="clone_property(<?php echo $pid; ?>);">
        <span><?php echo __('Clone', 'wpl'); ?></span>
    ...
    <div class="pmanager-multi-agent">
        <label id="pmanager_additional_agents_label<?php echo $pid; ?>" for="pmanager_additional_agents_select<?php echo $pid; ?>"><?php echo __('Additional Agents', 'wpl'); ?>: </label>
        <select id="pmanager_additional_agents_select<?php echo $pid; ?>" data-has-chosen multiple="true" data-chosen-opt="width:100%" onchange="additional_agents(<?php echo $pid; ?>);">
            <?php foreach($wpl_users as $wpl_user): ?>
