...
<table class="widefat page" cellspacing="0" width="100%">
    <thead>
        <tr>
            <th>
                <?php echo __('Name', 'wpl'); ?>
            </th>
            <th>
                <?php echo __('Type', 'wpl'); ?>
            </th>
            <th></th>
            <th></th>
    ...
    <tbody class="sortable">
        <?php foreach ($this->fields as $field): ?>
            <tr id="item_row_<?php echo $field->id; ?>">
                ...
                <td><?php echo __($field->name, 'wpl'); ?></td>
                ...
                <td class="wpl_manager_td">
                    ...
                    <span class="action-btn icon-star <?php echo $wpl_field_mandatory_always_class; ?>" id="wpl_flex_field_mandatory_always_span<?php echo $field->id; ?>" title="<?php echo __('This field is always mandatory.', 'wpl'); ?>"></span>
                    <span class="action-btn icon-star disable <?php echo $wpl_field_mandatory_never_class; ?>" id="wpl_flex_field_mandatory_never_span<?php echo $field->id; ?>" title="<?php echo __('This field is never mandatory.', 'wpl'); ?>" ></span>
                </td>
                ...
                <td class="wpl_manager_td">
                    <span class="action-btn icon-add-to-sort-options <?php echo $wpl_field_sort_option_disable_class; ?>" id="wpl_flex_field_sort_option_dis_span<?php echo $field->id; ?>" onclick="wpl_sort_option(<?php echo $field->id; ?>, <?php echo $this->kind ?>, 1);" title="<?php echo __('Add to available sort options.', 'wpl'); ?>"></span>
                    <span class="action-btn icon-remove-from-sort-options <?php echo $wpl_field_sort_option_class; ?>" id="wpl_flex_field_sort_option_span<?php echo $field->id; ?>" onclick="wpl_sort_option(<?php echo $field->id; ?>, <?php echo $this->kind ?>, 0);" title="<?php echo __('Remove from sort options.', 'wpl'); ?>"></span>

                    <span class="action-btn icon-remove-from-sort-options disable <?php echo $wpl_field_sort_option_always_class; ?>" id="wpl_flex_field_sort_option_always_span<?php echo $field->id; ?>" title="<?php echo __('This field is always sortable.', 'wpl'); ?>"></span>
                    <span class="action-btn icon-add-to-sort-options disable <?php echo $wpl_field_sort_option_never_class; ?>" id="wpl_flex_field_sort_option_never_span<?php echo $field->id; ?>" title="<?php echo __('This field is not sortable.', 'wpl'); ?>" ></span>
                </td>
                <td class="wpl_manager_td">
