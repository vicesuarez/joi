...
function wpl_set_enabled_location(location_id, enabeled_status)
{
	if(!location_id)
	{
		wpl_show_messages("<?php echo addslashes(__('Invalid Location', 'wpl')); ?>", '.wpl_location_list .wpl_show_message');	
		return false;
	}
...
function wpl_generate_modify_page(level, parent, location_id)
{
	...
	wplj.ajax(
	{
		...
		{
			wpl_show_messages('<?php echo addslashes(__('Error Occured.', 'wpl')); ?>', '.wpl_location_list .wpl_show_message', 'wpl_red_msg');
...
function wpl_remove_location(level, location_id, confirmed)
{
	...
	{
		wpl_show_messages("<?php echo addslashes(__('Invalid Location or level', 'wpl')); ?>", '.wpl_location_list .wpl_show_message');
		return false;
	}
	
	if(!confirmed)
	{
		message = "<?php echo addslashes(__('Are you sure you want to remove this item?', 'wpl')); ?>&nbsp;(<?php echo addslashes(__('Level', 'wpl')); ?>:"+level+", <?php echo addslashes(__('ID', 'wpl')); ?>:"+location_id+")&nbsp;<?php echo addslashes(__('All related items will be removed.', 'wpl')); ?>";
		message += '<span class="wpl_actions" onclick="wpl_remove_location(\''+level+'\',\''+location_id+'\', 1);"><?php echo addslashes(__('Yes', 'wpl')); ?></span>&nbsp;<span class="wpl_actions" onclick="wpl_remove_message();"><?php echo addslashes(__('No', 'wpl')); ?></span>';
