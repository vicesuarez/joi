	...
	wplj(function()
	{
		wplj('#wpl_notification_form').submit(function(e)
		{
			...
			ajax.success(function(data)
			{
				...
				wpl_show_messages('<?php echo __('Notification modified succesfully.', 'wpl'); ?>', '.wpl_notification_modify .wpl_show_message', 'wpl_green_msg');
...
function add_recipients(sel,inc,field)
{
	...
	if(field == 'email_recipients')
	{
		...
		{
			wpl_alert("<?php echo __("Please enter a valid email address", 'wpl'); ?>");
			return;
		}
	...
	else
	{
		...
		{
			wpl_alert("<?php echo __("Please select at least one option", 'wpl'); ?>");
			return;
		}
