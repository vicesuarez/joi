...
<table class="widefat page">
    <thead>
        <tr>
        	<th scope="col" class="size-1 manage-column" colspan="2"><?php echo __('Listing Types', 'wpl'); ?></th>
            <th colspan="5">
    ...
    <tbody class="sortable_list_type">
        <?php foreach($this->listing_types as $id=> $wp_listing_type): ?>
            <tr id="item_row_<?php echo $wp_listing_type['id']; ?>">
                ...
                <td><?php echo __($wp_listing_type['name'], 'wpl'); ?></td>
                <td class="manager-wp">
