...
<div class="fanc-content size-width-1">
    <h2><?php echo (isset($this->listing_type_data->name) ? $this->listing_type_data->name : __('Add new listing type', 'wpl')); ?></h2>
    <div class="fanc-body">
        <div class="fanc-row">
            <label for="wpl_title<?php echo $this->listing_type_id; ?>"><?php echo __('Name', 'wpl'); ?></label>
        ...
        <div class="fanc-row">
            <label for="wpl_parent<?php echo $this->listing_type_id; ?>"><?php echo __('Category', 'wpl'); ?></label>
        ...
        <div class="fanc-row">
            <label for="wpl_gicon<?php echo $this->listing_type_id; ?>"><?php echo __('Google Icon', 'wpl'); ?></label>
