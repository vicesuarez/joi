...
function wpl_sort_options_enabled_change(id)
{
	if(!id)
	{
		wpl_show_messages("<?php echo addslashes(__('Invalid sort option!', 'wpl')); ?>", '.wpl_show_message');
		return false;
	}
	...
	request_str = 'wpl_format=b:data_structure:ajax_sort_options&wpl_function=sort_options_enabled_state_change&id='+id+'&enabled_status='+enabled_status+'&_wpnonce=<?php echo $this->nonce; ?>';
...
{	
	...
	wplj(ajax_loader_element).html('<img src="<?php echo wpl_global::get_wpl_asset_url('img/ajax-loader3.gif'); ?>" />');	
	request_str = 'wpl_format=b:data_structure:ajax_sort_options&wpl_function=save_sort_option&id='+id+'&sort_name='+sort_name+'&_wpnonce=<?php echo $this->nonce; ?>';
