...
function wpl_remove_listing_type(listing_type_id, confirmed)
{
	if (!listing_type_id)
	{
		wpl_show_messages("<?php echo addslashes(__('Invalid Listing Types', 'wpl')); ?>", '.wpl_data_structure_list .wpl_show_message');
		return false;
	}
...
function wpl_set_enabled_listing_type(listing_type_id, enabled_status)
{
	if (!listing_type_id)
	{
		wpl_show_messages("<?php echo addslashes(__('Invalid listing Type', 'wpl')); ?>", '.wpl_data_structure_list .wpl_show_message');
		return false;
	}
...
function wpl_gicon_delete(icon, confirmed, index)
{
	if (!icon)
	{
		wpl_show_messages("<?php echo addslashes(__('Invalid Icon', 'wpl')); ?>", '.wpl_data_structure_list_gicon .wpl_show_message');
		return false;
	}

	if (!confirmed)
	{
		message = "<?php echo addslashes(__('Are you sure you want to remove this item?', 'wpl')); ?>&nbsp;(" + icon + ")&nbsp;<?php echo addslashes(__('All related items will be removed.', 'wpl')); ?>";
		message += '<span class="wpl_actions" onclick="wpl_gicon_delete(\'' + icon + '\', 1, ' + index + ');"><?php echo addslashes(__('Yes', 'wpl')); ?></span>&nbsp;<span class="wpl_actions" onclick="wpl_remove_message();"><?php echo addslashes(__('No', 'wpl')); ?></span>';
...
function wpl_ajax_insert_listing_type(id)
{
    ...
    if(parent == '')
    {
        wpl_show_messages('<?php echo addslashes(__('Select category!', 'wpl')); ?>', '.wpl_show_message' + id, 'wpl_red_msg');
        return;
    }
