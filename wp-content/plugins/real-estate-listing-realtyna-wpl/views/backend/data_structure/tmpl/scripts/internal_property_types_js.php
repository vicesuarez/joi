...
function wpl_remove_property_type(property_type_id, confirmed)
{
	if (!property_type_id)
	{
		wpl_show_messages("<?php echo addslashes(__('Invalid Property Types', 'wpl')); ?>", '.wpl_data_structure_list .wpl_show_message');
		return false;
	}
...
function wpl_set_enabled_property_type(property_type_id, enabeled_status)
{
	if (!property_type_id)
	{
		wpl_show_messages("<?php echo addslashes(__('Invalid Property Type', 'wpl')); ?>", '.wpl_data_structure_list .wpl_show_message');
		return false;
	}
