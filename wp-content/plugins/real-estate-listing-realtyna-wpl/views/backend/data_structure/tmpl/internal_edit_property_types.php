...
<div class="fanc-content size-width-1">
    <h2><?php echo (isset($this->property_type_data->name) ? $this->property_type_data->name : __('Add new property type', 'wpl')); ?></h2>
    <div class="fanc-body">
        <div class="fanc-row">
            <label for="wpl_title<?php echo $this->property_type_id; ?>"><?php echo __('Name', 'wpl'); ?></label>
