...
class wpl_listing_controller extends wpl_controller
{
	...
	public function wizard($instance = array())
	{
		...
		if($this->mode == 'add')
		{
			...
			{
				$this->message = __("Limit reached. You can not add more property!", 'wpl');
				return parent::render($this->tpl_path, 'message');
			}
		...
		if($this->mode == 'edit')
		{
			if(!$this->values)
			{
				$this->message = __("Property does not exist!", 'wpl');
				return parent::render($this->tpl_path, 'message');
			}
			...
			{
				$this->message = __("You can not edit this property.", 'wpl');
				return parent::render($this->tpl_path, 'message');
			}
		}
