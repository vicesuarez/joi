...
<div class="wrap wpl-wp pwizard-wp wpl_view_container">
    <header>
        ...
        <h2><?php echo sprintf(__('Add/Edit %s', 'wpl'), __(ucfirst($this->kind_label), 'wpl')); ?></h2>
    </header>

    <div class="wpl_listing_list"><div class="wpl_show_message"></div></div>

    <div class="finilize-message <?php echo ($this->finalized ? 'hide' : ''); ?>" id="wpl_listing_remember_to_finalize" title="<?php echo __('Click to finalize property ...', 'wpl'); ?>" onclick="wplj('#wpl_slide_label_id10000').trigger('click');">
        <i class="icon-warning"></i>
        <span><?php echo __('Remember to finalize!', 'wpl'); ?></span>
    </div>
            ...
            <ul>
                ...
                <?php if($this->mode == 'add'): ?>
                    <li class="wpl-listing-discard-btn">
                        <a href="#" id="wpl_listing_discard" title="<?php echo __('Click to discard property', 'wpl'); ?>" onclick="wpl_discard('<?php echo $this->property_id; ?>', 0);">
                            <span id="wpl_listing_discard_loading"><?php echo __('Discard', 'wpl'); ?></span>
                ...
                <li class="finilized">
                    <a href="#10000" class="tab-finalize wpl_slide_label_id10000" id="wpl_slide_label_id10000" onclick="wpl_finalize(10000, '<?php echo $this->property_id; ?>');">
                        <span><?php echo __('Finalize', 'wpl'); ?></span>
                ...
                <div id="wpl_slide_container_id10000_after_save" class="hide">
                    <div class="after-finilize-wp">
                        ...
                        <div class="message-wp">
                            <span>
                                <?php echo __('Your property successfully finalized!', 'wpl'); ?>
                            </span>
                            <div class="finilize-btn-wp">
                                ...
                                ?>
                                <a class="wpl-button button-2" target="_blank" href="<?php echo $property_link; ?>"><?php echo __('View this listing', 'wpl'); ?></a>
                                <a class="wpl-button button-2" href="<?php echo $new_link; ?>"><?php echo __('Add new listing', 'wpl'); ?></a>
                                <a class="wpl-button button-2" href="<?php echo $manager_link; ?>"><?php echo sprintf(__('%s Manager', 'wpl'), __($this->kind_label, 'wpl')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
function wpl_discard(item_id, confirmed)
{
	...
	if(!confirmed)
	{
		var message = "<?php echo addslashes(__('Are you sure you want to remove this listing?', 'wpl')); ?>";
		message += '<span class="wpl_actions" onclick="wpl_discard(\''+item_id+'\', 1);"><?php echo addslashes(__('Yes', 'wpl')); ?></span>&nbsp;<span class="wpl_actions" onclick="wpl_remove_message(\'' + message_path + '\');"><?php echo addslashes(__('No', 'wpl')); ?></span>';
