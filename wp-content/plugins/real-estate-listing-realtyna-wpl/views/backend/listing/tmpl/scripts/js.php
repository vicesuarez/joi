...
function wpl_neighborhood_distance_type_select(table_name, table_column, value, item_id, field_id, form_element_id)
{
	if(wplj('#wpl_c_'+field_id+'_distance').val() == '')
	{
		...
		wpl_alert("<?php echo __("Please enter distance first!", 'wpl'); ?>");
	}
	else
	{
...
function number_to_th(number)
{
	...
	else if(number == 1) return "<?php echo __('First', 'wpl'); ?>";
	else if(number == 2) return "<?php echo __('Second', 'wpl'); ?>";
	else if(number == 3) return "<?php echo __('Third', 'wpl'); ?>";
	else if(number == 4) return "<?php echo __('Fourth', 'wpl'); ?>";
	else if(number == 5) return "<?php echo __('Fifth', 'wpl'); ?>";
	else if(number == 6) return "<?php echo __('Sixth', 'wpl'); ?>";
	else if(number == 7) return "<?php echo __('Seventh', 'wpl'); ?>";
	else if(number == 8) return "<?php echo __('Eighth', 'wpl'); ?>";
	else if(number == 9) return "<?php echo __('Nineth', 'wpl'); ?>";
	else if(number == 10) return "<?php echo __('Tenth', 'wpl'); ?>";
}
