...
<div class="wpl-maintenance-container">
    ...
    <form class="wpl-clear-cache-form" id="wpl_clear_cache_form">
        <ul>
            ...
            <li>
                <input type="checkbox" name="cache[listings_meta_keywords]" value="1" checked="checked" id="wpl_cache_listings_meta_keywords" />
                <span class="title">
                    <label for="wpl_cache_listings_meta_keywords"><?php echo __('Listings meta keywords', 'wpl'); ?></label>
                </span>
            </li>
            <li>
                <input type="checkbox" name="cache[listings_meta_description]" value="1" checked="checked" id="wpl_cache_listings_meta_description" />
                <span class="title">
