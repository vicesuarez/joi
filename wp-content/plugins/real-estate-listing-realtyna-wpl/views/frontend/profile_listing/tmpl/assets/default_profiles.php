        ...
        <div class="wpl_profile_picture">
            <div class="front">
                <?php
                    ...
                    elseif(isset($profile['company_logo']['url'])) echo '<img itemprop="image" src="'.$profile['company_logo']['url'].'" alt="'.$agent_name.' '.$agent_l_name.'" />';
                    else echo '<div class="no_image"></div>';
                ?>
            </div>
            <div class="back">
                <a itemprop="url" href="<?php echo $profile['profile_link']; ?>" class="view_properties"><?php echo __('View properties', 'wpl'); ?></a>
            </div>
        </div>
        ...
        <div class="wpl_profile_container_title">
            <?php
                echo '<div class="title" itemprop="name">
                        ...
                        <a itemprop="url" href="'.$profile['profile_link'].'>" class="view_properties">'. __('View properties', 'wpl').'</a>
                      </div>';
