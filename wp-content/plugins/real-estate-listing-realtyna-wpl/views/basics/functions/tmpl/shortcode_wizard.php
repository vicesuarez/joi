...
<div class="short-code-wp wpl_shortcode_wizard_container" id="wpl_shortcode_wizard_container" style="margin: 0 20px;">
    <h2>
        ...
        <span><?php echo __('WPL Shortcodes', 'wpl'); ?></span>
    ...
    <div class="short-code-body">
        <div class="plugin-row wpl_select_view">
            ...
            <select id="view_selectbox" onchange="wpl_view_selected(this.value);">
                <option value="property_listing"><?php echo __('Property Listing', 'wpl'); ?></option>
                <option value="property_show"><?php echo __('Property Show', 'wpl'); ?></option>
                <option value="profile_listing"><?php echo __('Profile/Agent Listing', 'wpl'); ?></option>
                <option value="profile_show"><?php echo __('Profile/Agent Show', 'wpl'); ?></option>
                <option value="profile_wizard"><?php echo __('My Profile', 'wpl'); ?></option>
                <?php if(wpl_global::check_addon('pro')): ?><option value="widget_shortcode"><?php echo __('Widget Shortcode', 'wpl'); ?></option><?php endif; ?>
                <?php if(wpl_global::check_addon('save_searches')): ?><option value="save_searches"><?php echo __('Save Searches', 'wpl'); ?></option><?php endif; ?>
            </select>
        </div>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing">
            ...
            <label for="pr_listing_type_selectbox"><?php echo __('Listing type', 'wpl'); ?></label>
            <select id="pr_listing_type_selectbox" name="sf_select_listing">
            	<option value="-1"><?php echo __('All', 'wpl'); ?></option>
                <?php foreach($listings as $listing): ?>
				<option value="<?php echo $listing['id']; ?>"><?php echo __($listing['name'], 'wpl'); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing">
            ...
            <label for="pr_property_type_selectbox"><?php echo __('Property type', 'wpl'); ?></label>
            <select id="pr_property_type_selectbox" name="sf_select_property_type">
            	<option value="-1"><?php echo __('All', 'wpl'); ?></option>
                <?php foreach($property_types as $property_type): ?>
				<option value="<?php echo $property_type['id']; ?>"><?php echo __($property_type['name'], 'wpl'); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing">
            ...
            <label for="pr_tpl_selectbox"><?php echo __('Layout', 'wpl'); ?></label>
            <select id="pr_tpl_selectbox" name="tpl">
                <?php foreach($property_listing_layouts as $layout): ?>
				<option value="<?php echo ($layout != 'default' ? $layout : ''); ?>" <?php if($layout == 'default') echo 'selected="selected"'; ?>><?php echo __($layout, 'wpl'); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing">
            ...
            <label for="pr_location_textsearch"><?php echo __('Location', 'wpl'); ?></label>
            <input type="text" id="pr_location_textsearch" name="sf_locationtextsearch" placeholder="<?php echo __($location_settings['locationzips_keyword'].', '.$location_settings['location3_keyword'].', '.$location_settings['location1_keyword'], 'wpl'); ?>" />
        </div>
        
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing">
            <label for="pr_price_min"><?php echo __('Price (Min)', 'wpl'); ?></label>
            <input type="text" id="pr_price_min" name="sf_min_price" />
        </div>
        
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing">
            <label for="pr_price_max"><?php echo __('Price (Max)', 'wpl'); ?></label>
            <input type="text" id="pr_price_max" name="sf_max_price" />
        </div>
        
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing">
            <?php $units = wpl_units::get_units(4); ?>
            <label for="pr_price_unit_selectbox"><?php echo __('Price Unit', 'wpl'); ?></label>
            <select id="pr_price_unit_selectbox" name="sf_unit_price">
                <?php foreach($units as $unit): ?>
				<option value="<?php echo $unit['id']; ?>"><?php echo __($unit['name'], 'wpl'); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing">
            <label for="pr_only_<?php echo $tag->table_column; ?>_selectbox"><?php echo __($tag->name, 'wpl'); ?></label>
            <select id="pr_only_<?php echo $tag->table_column; ?>_selectbox" name="sf_select_<?php echo $tag->table_column; ?>">
                <option value="-1"><?php echo __('Any', 'wpl'); ?></option>
                <option value="0"><?php echo __('No', 'wpl'); ?></option>
                <option value="1"><?php echo __('Yes', 'wpl'); ?></option>
            </select>
        </div>
        <?php endforeach; ?>
        ...
        <div class="plugin-row wpl_shortcode_parameter pr_property_listing pr_profile_show">
            ...
            <label for="pr_target_page_selectbox"><?php echo __('User', 'wpl'); ?></label>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_profile_listing">
            ...
            <label for="pr_user_type_selectbox"><?php echo __('User Type', 'wpl'); ?></label>
            <select id="pr_user_type_selectbox" name="sf_select_membership_type">
                <option value="">-----</option>
                <?php foreach($user_types as $user_type): ?>
				<option value="<?php echo $user_type->id; ?>"><?php echo __($user_type->name, 'wpl'); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_profile_listing">
            ...
            <label for="pr_membership_selectbox"><?php echo __('Membership', 'wpl'); ?></label>
            <select id="pr_membership_selectbox" name="sf_select_membership_id">
                <option value="">-----</option>
                <?php foreach($memberships as $membership): ?>
				<option value="<?php echo $membership->id; ?>"><?php echo __($membership->membership_name, 'wpl'); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <?php endif; ?>
        ...
        <div class="plugin-row wpl_shortcode_parameter pr_property_listing pr_profile_listing pr_profile_show">
            ...
            <label for="pr_target_page_selectbox"><?php echo __('Target page', 'wpl'); ?></label>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing pr_profile_listing">
            ...
            <label for="pr_limit_selectbox"><?php echo __('Page Size', 'wpl'); ?></label>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing pr_profile_listing pr_profile_show">
            <label for="pr_wplpagination_selectbox"><?php echo __('Pagination Type', 'wpl'); ?></label>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_listing pr_profile_listing">
            <label for="pr_order_selectbox"><?php echo __('Order', 'wpl'); ?></label>
            <select id="pr_order_selectbox" name="wplorder">
                <option value="DESC"><?php echo __('DESC', 'wpl'); ?></option>
                <option value="ASC"><?php echo __('ASC', 'wpl'); ?></option>
            </select>
        </div>
       
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_property_show">
            <label for="pr_mls_id_textbox"><?php echo __('Listing ID', 'wpl'); ?></label>
        ...
        <div class="plugin-row wpl_shortcode_parameter wpl_hidden_element pr_widget_shortcode">
            ...
            <label for="pr_widget_selectbox"><?php echo __('Widget', 'wpl'); ?></label>
