...
class wpl_agents_widget extends wpl_widget
{
	...
	{
		parent::__construct('wpl_agents_widget', __('(WPL) Agents', 'wpl'), array('description'=>__('Showing specific agents.', 'wpl')));
	}
	...
	public function form($instance)
	{
		...
		{
			$instance = array('title'=>__('Featured Agents', 'wpl'), 'layout'=>'default.php', 'data'=>array('limit'=>'4', 'orderby'=>'p.first_name', 'order'=>'DESC', 'image_width'=>'230', 'image_height'=>'230'));
