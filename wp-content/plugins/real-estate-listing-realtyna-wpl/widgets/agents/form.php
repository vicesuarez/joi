...
<div class="wpl_agents_widget_backend_form wpl-widget-form-wp" id="<?php echo $this->get_field_id('wpl_agents_widget_container'); ?>">
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('style'); ?>"><?php echo __('Style', 'wpl'); ?></label>
        <select id="<?php echo $this->get_field_id('style'); ?>" name="<?php echo $this->get_field_name('data'); ?>[style]">
            <option <?php if(isset($instance['data']['style']) and  $instance['data']['style']== '1') echo 'selected="selected"'; ?> value="1"><?php echo __('Horizontal', 'wpl'); ?></option>
            <option <?php if(isset($instance['data']['style']) and  $instance['data']['style']== '2') echo 'selected="selected"'; ?> value="2"><?php echo __('Vertical', 'wpl'); ?></option>
        </select>
    </div>
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('data_image_width'); ?>"><?php echo __('Image Width', 'wpl'); ?></label>
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('data_image_height'); ?>"><?php echo __('Image Height', 'wpl'); ?></label>
    ...
    <div class="wpl-widget-row">
    	<label for="<?php echo $this->get_field_id('data_user_type'); ?>"><?php echo __('User Type', 'wpl'); ?></label>
        <select id="<?php echo $this->get_field_id('data_user_type'); ?>" name="<?php echo $this->get_field_name('data'); ?>[user_type]">
            ...
            <option <?php if(isset($instance['data']['user_type']) and $instance['data']['user_type'] == $membership_type->id) echo 'selected="selected"'; ?> value="<?php echo $membership_type->id; ?>"><?php echo __($membership_type->name, 'wpl'); ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    ...
    <div class="wpl-widget-row">
    	<label for="<?php echo $this->get_field_id('data_membership'); ?>"><?php echo __('Membership', 'wpl'); ?></label>
        <select id="<?php echo $this->get_field_id('data_membership'); ?>" name="<?php echo $this->get_field_name('data'); ?>[membership]">
        	<option value=""><?php echo __('All', 'wpl'); ?></option>
            <?php foreach($memberships as $membership): ?>
            <option <?php if(isset($instance['data']['membership']) and $instance['data']['membership'] == $membership->id) echo 'selected="selected"'; ?> value="<?php echo $membership->id; ?>"><?php echo __($membership->membership_name, 'wpl'); ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    <?php endif; ?>
    ...
    <div class="wpl-widget-row">
    	<label for="<?php echo $this->get_field_id('data_user_ids'); ?>"><?php echo __('User IDs', 'wpl'); ?></label>
    ...
    <div class="wpl-widget-row">
    	<label for="<?php echo $this->get_field_id('data_limit'); ?>"><?php echo __('Number of users', 'wpl'); ?></label>
