...
<div class="wpl-widget-search-wp wpl-widget-form-wp" id="<?php echo $this->get_field_id('wpl_search_widget_container'); ?>">
    ...
    <div class="wpl-widget-row">
        ...
        <select id="<?php echo $this->get_field_id('kind'); ?>" name="<?php echo $this->get_field_name('kind'); ?>"
            ...
            <option <?php if(isset($instance['kind']) and $instance['kind'] == $kind['id']) echo 'selected="selected"'; ?> value="<?php echo $kind['id']; ?>"><?php echo __($kind['name'], 'wpl'); ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    ...
    <div class="wpl-widget-row">
        ...
        <select id="<?php echo $this->get_field_id('wpltarget'); ?>"
            ...
            <option value="-1" <?php echo ((isset($instance['wpltarget']) and $instance['wpltarget'] == '-1') ? 'selected="selected"' : ''); ?>><?php echo __('Self Page', 'wpl'); ?></option>
        </select>
    </div>
    
    <?php if(wpl_global::check_addon('aps')): ?>
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('ajax'); ?>"><?php echo __('AJAX Search', 'wpl'); ?></label>
        <select id="<?php echo $this->get_field_id('ajax'); ?>"
               name="<?php echo $this->get_field_name('ajax'); ?>">
            <option value="0" <?php if(isset($instance['ajax']) and $instance['ajax'] == 0) echo 'selected="selected"'; ?>><?php echo __('No', 'wpl'); ?></option>
            <option value="1" <?php if(isset($instance['ajax']) and $instance['ajax'] == 1) echo 'selected="selected"'; ?>><?php echo __('Yes', 'wpl'); ?></option>
            <option value="2" <?php if(isset($instance['ajax']) and $instance['ajax'] == 2) echo 'selected="selected"'; ?>><?php echo __('Yes (On the fly)', 'wpl'); ?></option>
        </select>
    </div>
    <?php endif; ?>
    
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('css_class'); ?>"><?php echo __('CSS Class', 'wpl'); ?></label>
    ...
    <?php if(wpl_global::check_addon('aps')): ?>
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('more_options_type'); ?>"><?php echo __('More Options Type', 'wpl'); ?></label>
        <select id="<?php echo $this->get_field_id('more_options_type'); ?>" name="<?php echo $this->get_field_name('more_options_type'); ?>">
            <option value="0" <?php if(isset($instance['more_options_type']) and $instance['more_options_type'] == 0) echo 'selected="selected"'; ?>><?php echo __('Slide', 'wpl'); ?></option>
            <option value="1" <?php if(isset($instance['more_options_type']) and $instance['more_options_type'] == 1) echo 'selected="selected"'; ?>><?php echo __('Pop-up', 'wpl'); ?></option>
        </select>
    </div>
    <?php endif; ?>
