...
class wpl_users
{
	...
	public static function generate_location_text($user_data, $user_id = 0, $glue = ',')
	{
        ...
        if(isset($user_data['location7_name']) and trim($user_data['location7_name']) != '') $locations['location7_name'] = __($user_data['location7_name'], 'wpl');
        if(isset($user_data['location6_name']) and trim($user_data['location6_name']) != '') $locations['location6_name'] = __($user_data['location6_name'], 'wpl');
		if(isset($user_data['location5_name']) and trim($user_data['location5_name']) != '') $locations['location5_name'] = __($user_data['location5_name'], 'wpl');
        if(isset($user_data['location4_name']) and trim($user_data['location4_name']) != '') $locations['location4_name'] = __($user_data['location4_name'], 'wpl');
        if(isset($user_data['location3_name']) and trim($user_data['location3_name']) != '') $locations['location3_name'] = __($user_data['location3_name'], 'wpl');
        if(isset($user_data['location2_name']) and trim($user_data['location2_name']) != '') $locations['location2_name'] = __($user_data['location2_name'], 'wpl');
        if(isset($user_data['location1_name']) and trim($user_data['location1_name']) != '') $locations['location1_name'] = __($user_data['location1_name'], 'wpl');
	...
	public static function insert_user($user_data)
	{
		...
		{
			return new WP_Error('broke', __("ERROR: Required fileds are invalid!", 'wpl'));
		}
	}
	...
	public static function login_user($user_data)
	{
		...
		{
			return new WP_Error('broke', __('ERROR: Required fields are invalid!', 'wpl'));
		}
	}
