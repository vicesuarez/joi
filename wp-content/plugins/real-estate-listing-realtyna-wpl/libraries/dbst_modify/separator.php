...
<div class="fanc-body">
    ...
    <div class="col-wp">
		...
		<div class="col-fanc-right" id="wpl_flex_specific_options">
            ...
            <div class="fanc-row">
				<label for="<?php echo $__prefix; ?>opt_show_label"><?php echo __('Show Label', 'wpl'); ?></label>
				<select name="<?php echo $__prefix; ?>opt_show_label" id="<?php echo $__prefix; ?>opt_show_label">
			        <option value="1" <?php if (isset($options['show_label']) and $options['show_label'] == '1') echo 'selected="selected"'; ?>><?php echo __('Yes', 'wpl'); ?></option>
			        <option value="0" <?php if (!isset($options['show_label']) or  $options['show_label'] != '1') echo 'selected="selected"'; ?>><?php echo __('No', 'wpl'); ?></option>
			    </select>
			</div>
		</div>
	</div>
