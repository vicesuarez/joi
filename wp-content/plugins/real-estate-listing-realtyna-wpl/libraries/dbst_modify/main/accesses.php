...
<div class="fanc-row">
    <div class="fanc-row">
        <label for="<?php echo $__prefix; ?>accesses"><?php echo __('Viewable by', 'wpl'); ?></label>
        <select id="<?php echo $__prefix; ?>accesses" name="<?php echo $__prefix; ?>accesses" onchange="wpl_flex_change_accesses(this.value, '<?php echo $__prefix; ?>');">
            ...
            <option value="1" <?php if(isset($values->accesses) and trim($values->accesses) != '') echo 'selected="selected"'; ?>><?php echo __('Selected Users', 'wpl'); ?></option>
        </select>
    </div>
