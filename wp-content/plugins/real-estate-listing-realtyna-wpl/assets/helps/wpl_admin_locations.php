...
$content = '<h3>'.__('WPL Locations', 'wpl').'</h3><p>'.__("Here you can manage, enabled countries and add new locations into the WPL such as states/provinces of your desired countries.", 'wpl').'</p>';
$tabs['tabs'][] = array('id'=>'wpl_contextual_help_tab_int', 'content'=>$content, 'title'=>__('Introduction', 'wpl'));

$articles  = '';
$articles .= '<li><a href="https://support.realtyna.com/index.php?/Default/Knowledgebase/Article/View/527/" target="_blank">'.__("How to use Location Manager in WPL?", 'wpl').'</a></li>';
...
$articles .= '<li><a href="https://support.realtyna.com/index.php?/Default/Knowledgebase/Article/View/562/" target="_blank">'.__("How do I add/remove location levels to WPL?", 'wpl').'</a></li>';
