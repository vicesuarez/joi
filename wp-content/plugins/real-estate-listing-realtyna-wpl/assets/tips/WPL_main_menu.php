...
$content = '<h3>'.__('WPL Dashboard', 'wpl').'</h3><p>'.__('Welcome to WPL dashboard, Here you can see some important information about WPL and its add-ons.', 'wpl').'</p>';
...
$content = '<h3>'.__('Optional add-ons', 'wpl').'</h3><p>'.__('WPL has some optional add-ons for extending its functionality. You can download and install if needed.', 'wpl').'</p>';
...
$content = '<h3>'.__('Update WPL PRO and its add-ons', 'wpl').'</h3><p>'.__('Here you can update your WPL PRO and its addons.', 'wpl').'</p>';
...
$content = '<h3>'.__('Browse KB articles', 'wpl').'</h3><p>'.__('You can find all of WPL KB articles here. Even you can search on them. If you have any questions, please search on KB articles first. In most of times you will find your answer in minutes.', 'wpl').'</p>';
