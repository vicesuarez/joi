...
class WP_Listings {
	...
	function __construct() {
		...
		$this->property_details = apply_filters( 'wp_listings_property_details', array(
			'col1' => array(
			    __( 'Precio:', 'wp-listings' ) 					=> '_listing_price',
			    __( 'Dirección:', 'wp-listings' )					=> '_listing_address',
			    __( 'Ciudad:', 'wp-listings' )					=> '_listing_city',
			    __( 'Partido:', 'wp-listings' )					=> '_listing_county',
			    __( 'Provincia:', 'wp-listings' )					=> '_listing_state',
			    __( 'Pais:', 'wp-listings' )					=> '_listing_country',
			    __( 'Código postal:', 'wp-listings' )						=> '_listing_zip',
			    __( 'MLS #:', 'wp-listings' ) 					=> '_listing_mls',
				__( 'Horario:', 'wp-listings' ) 	=> '_listing_open_house'
			),
			'col2' => array(
			    __( 'Año construcción:', 'wp-listings' ) 				=> '_listing_year_built',
			    __( 'Pisos:', 'wp-listings' ) 					=> '_listing_floors',
			    __( 'Metros cuadrados:', 'wp-listings' )				=> '_listing_sqft',
				__( 'Metros cuadrados lote:', 'wp-listings' )			=> '_listing_lot_sqft',
			    __( 'Habitaciones:', 'wp-listings' )				=> '_listing_bedrooms',
			    __( 'Baños:', 'wp-listings' )				=> '_listing_bathrooms',
			    __( 'Half Bathrooms:', 'wp-listings' )			=> '_listing_half_bath',
			    __( 'Garage:', 'wp-listings' )					=> '_listing_garage',
			    __( 'Piscina:', 'wp-listings' )					=> '_listing_pool'
			),
		) );

		$this->extended_property_details = apply_filters( 'wp_listings_extended_property_details', array(
			'col1' => array(
			    __( 'Tipo de propiedad:', 'wp-listings' ) 			=> '_listing_proptype',
			    __( 'Condominio:', 'wp-listings' )					=> '_listing_condo',
			    __( 'Financiación:', 'wp-listings' )				=> '_listing_financial',
			    __( 'Condición:', 'wp-listings' )				=> '_listing_condition',
			    __( 'Construcción:', 'wp-listings' )			=> '_listing_construction',
				...
				__( 'Piso:', 'wp-listings' ) 				=> '_listing_flooring',
				__( 'Heat/Cool:', 'wp-listings' ) 				=> '_listing_heatcool'
			),
			'col2' => array(
				__( 'Tamaño del lote:', 'wp-listings' ) 				=> '_listing_lotsize',
				__( 'Ubicación:', 'wp-listings' ) 				=> '_listing_location',
				...
				__( 'Cuartos:', 'wp-listings' )					=> '_listing_rooms',
